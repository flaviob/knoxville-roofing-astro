export const site = {
  business: {
    ...
    address: "1924 Laurans Ave, Knoxville, TN 37915",
    addressShort: "1924 Laurans Ave, Knoxville",
    ...
    tagline: "A roofing company you can Trust",
    subTagline: "Built on Honesty, Quality, and Accountability.",
    promise: "Lifetime no-leak guarantee. Free inspections. Same-week installs.",
    ownerQuote: {
      text: "At Daniel Hood Roofing Systems, trust isn't just a phrase — it's the foundation of everything we do. We've built our reputation on treating every home as if it were our own.",
      attribution: "Daniel Hood, Owner",
    },
    humanTouch: "The human touch. We look after our customers because you matter.",
  },
  areas: [
  ...
  reviews: [
    ...
    {
      name: "Sue Guy",
      text: "Daniel personally walked the roof with me, showed me photos of the damage, and explained every line on the quote. No pressure, no upsell. Just honest work.",
      stars: 5,
    ...
    {
      name: "Felicia Barnes",
      text: "From the first call to the final inspection, this team was a class act. The crew protected our landscaping and left the yard cleaner than they found it.",
      stars: 5,
